  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(ellipse at center, ${character.colors.secondary}10 0%, transparent 70%)`,
        }}
      >
...
const ForgeCharacters: React.FC = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h2 className="font-playfair text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 tracking-tight">
            THE <span className="text-[#D4AF37]">FORGE</span>
          </h2>
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Meet the elite unit powering your digital transformation
          </p>
...
export default ForgeCharacters;
